...
//  CryptoApp
//
//  Created by Viktoria Lobanova on 04.10.2023.
//
...
class HomeViewModel: ObservableObject {
    ...
    enum SortOption {
        case rank, rankReversed, holdings, holdingsReverced, price, priceReverced
    }
    ...
    private func sortCoins(sort: SortOption, coins: inout [CoinModel]) {
        ...
        case .rankReversed, .holdingsReverced:
            coins.sort(by: { $0.rank > $1.rank})
        case .price:
    ...
    private func mapGlobalMarketData(marketDataModel: MarketDataModel?, portfolioCoins: [CoinModel]) -> [StatisticModel] {
        ...
        let volume = StatisticModel(
            title: "24h Volume",
            value: data.volume)
        let btcDominice = StatisticModel(
            title: "BTC Dominice",
